...
class Hero(GameObject[GameObjectType]):
    def __init__(self, x: int, y: int, hero_speed: int, window_width: int):  # Add arguments
    ...
    def update(self):
        ...
        if keys[pygame.K_RIGHT] and self.rect.right < self.window_width:  # Use stored value
            self.rect.x += self.speed